...
## Data Model
- `shipments` as the fact table
- `calendar` as the date table
- `products` as the product dimension
- `people` as the salesperson dimension
- `locations` as the geography dimension
...
## Key Insights
- Top salespersons contributed the largest share of revenue.
- A few products generated most of the profit.
- Some regions performed better than others.
- Profit margin varied across products.
- Monthly trends showed clear business patterns.
